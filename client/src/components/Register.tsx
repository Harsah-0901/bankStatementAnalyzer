...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-start bg-gray-100 w-full">
      <div className="w-full max-w-md bg-gray-300 rounded-lg shadow-md p-8 h-[65vh] flex items-center justify-center flex-col">
